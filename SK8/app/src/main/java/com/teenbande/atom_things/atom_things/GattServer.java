...
import static com.teenbande.atom_things.atom_things.AtomProfile.CHARACTERISTIC_INTERACTOR_UUID;
import static com.teenbande.atom_things.atom_things.AtomProfile.CHARACTERISTIC_SPEED_UUID;
import static com.teenbande.atom_things.atom_things.AtomProfile.DESCRIPTOR_CONFIG;
import static com.teenbande.atom_things.atom_things.AtomProfile.DESCRIPTOR_USER_DESC;
import static com.teenbande.atom_things.atom_things.AtomProfile.SERVICE_UUID;
...
public class GattServer {
    ...
    private BluetoothGattServerCallback mGattServerCallback = new BluetoothGattServerCallback() {
        ...
        public void onCharacteristicReadRequest(BluetoothDevice device, int requestId, int offset, BluetoothGattCharacteristic characteristic) {
            if (CHARACTERISTIC_SPEED_UUID.equals(characteristic.getUuid())) {
                Log.i(TAG, "Read counter");
                byte[] value = mListener.onSpeedRead();
        ...
        public void onCharacteristicWriteRequest(BluetoothDevice device, int requestId, BluetoothGattCharacteristic characteristic, boolean preparedWrite, boolean responseNeeded, int offset, byte[] value) {
            if (CHARACTERISTIC_INTERACTOR_UUID.equals(characteristic.getUuid())) {
                ...
                if (mListener != null) {
                    mListener.onInteractorWritten(new BigInteger(value).intValue());
                }
        ...
        public void onDescriptorReadRequest(BluetoothDevice device, int requestId, int offset, BluetoothGattDescriptor descriptor) {
            if (DESCRIPTOR_CONFIG.equals(descriptor.getUuid())) {
                ...
                byte[] returnValue = AtomProfile.getUserDescription(descriptor.getCharacteristic().getUuid());
    ...
    private void startAdvertising() {
        BluetoothAdapter bluetoothAdapter = mBluetoothManager.getAdapter();
//        bluetoothAdapter.setName("Atom Speed Service");
    ...
    private BluetoothGattService createAwesomenessService() {
        ...
        BluetoothGattCharacteristic speed = new BluetoothGattCharacteristic(CHARACTERISTIC_SPEED_UUID,
                BluetoothGattCharacteristic.PROPERTY_READ | BluetoothGattCharacteristic.PROPERTY_NOTIFY,
                BluetoothGattCharacteristic.PERMISSION_READ);
        BluetoothGattDescriptor speedConfig = new BluetoothGattDescriptor(DESCRIPTOR_CONFIG, BluetoothGattDescriptor.PERMISSION_READ | BluetoothGattDescriptor.PERMISSION_WRITE);
        speed.addDescriptor(speedConfig);
        ...
        speed.addDescriptor(counterDescription);
        ...
        service.addCharacteristic(speed);
    ...
    private void notifyRegisteredDevices() {
        ...
        for (BluetoothDevice device : mRegisteredDevices) {
            BluetoothGattCharacteristic counterCharacteristic = mBluetoothGattServer
                    ...
                    .getCharacteristic(CHARACTERISTIC_SPEED_UUID);
            byte[] value = mListener.onSpeedRead();
    ...
    public interface GattServerListener {
        void onInteractorWritten(int Wspeed);
